...
const apiKey = '&APPID=4721b78b057da8a524e1f6d05dd1806e'
...
function performAction() {
	...
	retrieveWeatherData(base_URL, zipCode, apiKey)
		.then(function (data) {
			...
			postData('https://weatherappone.herokuapp.com/saveData', {
				temp: data.main.temp,
				date: newDate,
		...
		.then(function () {
			getData("https://weatherappone.herokuapp.com/getRecentWeatherData")
				.then(function (data) {
